...
import CoolLinks4 from "../assets/projectImg/CoolLinks4.png";
...
const projectInfo: Project[] = [
    ...
    },
    {
        ...
        name: "cool links",
        description:
            "A simple tool for saving captivating links discovered across the the internet for easy access in the future. Categorize these links into collections and locate your saved links using intuitive keyword searches.",
        tech: "Typescript, React, Shadcn, Tailwind, Vite, Link Preview API",
        livePreview: "https://cool-links.netlify.app/",
        code: "https://github.com/paigebraun/cool-links-v2",
        src: [CoolLinks1, CoolLinks2, CoolLinks3, CoolLinks4],
    },
    /*{
        id: 'to-do-list',
        name: 'to do list',
